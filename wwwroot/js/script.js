(function ($) {
  ...
  var initJarallax = function () {
    ...
    function removeFromCart() {
        // Example action: Remove product from cart logic
        // You can target the specific product by adding additional parameters or identifiers
        console.log("Product removed from the cart.");
        // Further code to remove the item can be added here
    }
